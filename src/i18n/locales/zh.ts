...
const zh: Translation = {
  ...
  whoWeAre: {
    ...
    headline: "为复杂用工场景而生。",
    body1:
      "Mars 帮助企业跨境招聘、管理和支付人才。我们将技术驱动的运营与经验丰富的用工专家相结合，在速度、准确性与执行力最为关键的环节交付成果。",
    body2:
      "无论是支持一次关键的高管招聘，还是管理跨多个司法辖区的薪资，我们的关注点始终如一：可靠地执行，每一次都如此。",
  },
  coreServices: {
    eyebrow: "我们做什么。",
    headline: "核心服务",
    executiveSearch: {
      ...
      title: "高管猎头",
      body:
        "领导层招聘、专业人才寻访与难填补岗位。市场地图与人才情报。以精准交付关键招聘。",
      cta: "了解高管猎头",
    },
    payrollAnywhere: {
      tag: "全球薪资",
      title: "全球薪资",
      body:
        "跨多个国家的准确薪资处理。薪资发放、法定申报与员工工资单——并提供跨境用工支持。",
      cta: "了解全球薪资",
    },
    workforceOps: {
      tag: "用工运营",
  ...
  whyChoose: {
    ...
    b1Title: "员工启用",
    b1Body:
      "快速启用员工——以精简的流程和运营上的精准完成员工入职或离职。",
    b2Title: "人才匹配",
    b2Body:
      "快速人才匹配——从全球人才网络中迅速识别并筛选候选人。",
    b3Title: "薪资交付",
    b3Body:
      "可靠、快速的薪资交付，由优化后的支付运营提供支撑。",
    b4Title: "全球用工覆盖",
    b4Body:
      "通过一套运营框架支持跨多个国家的用工。",
    b5Title: "超越自动化的人工专业能力",
    b5Body:
      "技术处理常规流程，经验丰富的专家解决例外情况。",
  },
  challenges: {
    eyebrow: "我们解决的业务难题",
    headline: "为真实的运营挑战而设计。",
    c1Problem: "招聘耗时太长",
    c1Solution:
      "大幅缩短寻访、筛选与初选周期。",
    c2Problem: "薪资管理零散割裂",
  ...
  approach: {
    ...
    p1Body: "在讲求效率之处运用自动化。",
    p2Title: "专人主导",
    p2Body: "在需要判断之处，由经验丰富的用工专家介入。",
    p3Title: "以结果为导向",
    p3Body: "以执行、速度与准确性来衡量，而非以活动量。",
  },
  metrics: {
    eyebrow: "成效",
    headline: "真正重要的数字。",
    ...
    marketsLabel: "覆盖市场",
    marketsValue: "10",
    consultantsLabel: "专业顾问",
    consultantsValue: "100+",
    onboardingLabel: "入职周期",
    onboardingValue: "5 天",
    missesLabel: "法定违规（自 2009 年）",
    missesValue: "0",
  },
  vsSoftware: {
    eyebrow: "与软件不同",
    headline: "平台止步之处，Mars 接手。",
    body:
      "大多数用工平台只是自动化任务，而 Mars 解决例外情况——复杂招聘、跨境薪资、监管复杂性、敏感用工状况，以及业务关键的用工运营。当自动化触及极限时，经验丰富的专家方显价值。",
  },
  finalCta: {
    eyebrow: "立即开始",
    headline: "用工运营，没有运营摩擦。",
    body:
      "无论你是在招聘关键人才、管理全球薪资，还是拓展新市场，Mars 都以速度、精准与责任担当交付用工运营。",
    ctaPrimary: "预约咨询",
    ctaSecondary: "联系我们的团队",
  },
  countries: {
    eyebrow: "覆盖范围",
  ...
  insightsPage: {
    metaTitle: "洞察 — Mars Consulting",
    metaDesc:
      "Mars Consulting 对高管猎头、跨境薪资及用工运营的专业洞见。",
    pill: "洞察",
    headlineLead: "用工智识，",
    headlineAccent: "共享于此。",
    sub:
      "关于高管猎头、跨境薪资与用工运营的务实洞见——源自我们在多个司法管辖区为客户实际交付的经验。",
    eyebrow: "最新洞见",
    heading: "我们正在思考的议题。",
    comingSoon:
      "完整文章即将上线。以下是我们团队正在撰写的主题方向。",
    a1Tag: "高管猎头",
    a1Title: "关键招聘为何停滞——以及如何提速",
    a1Excerpt:
      "领导层招聘的真正瓶颈很少在于候选名单。我们剖析高管寻访在哪些环节流失时间，以及严谨的市场地图如何弥合这一差距。",
    a2Tag: "全球薪资",
    a2Title: "跨多个司法管辖区实现一致的薪资发放",
    a2Excerpt:
      "碎片化的薪资既是运营难题，更是合规风险。统一的运营框架如何确保各市场的法定申报按时完成。",
    a3Tag: "用工运营",
    a3Title: "自动化止于何处，判断始于何处",
    a3Excerpt:
      "平台能很好地处理常规的入职与离职。而例外情形——敏感个案与边缘合规——仍需经验丰富的专业人员。",
    a4Tag: "合规",
    a4Title: "领先于区域用工法规一步",
    a4Excerpt:
      "区域内的用工与法定要求不断变化。我们提供一种务实视角，助你将本地执行力融入用工运营。",
    ctaHeading: "想将这些应用到你的运营中？",
    ctaBody:
      "就高管猎头、全球薪资或跨市场用工运营，与我们的团队聊聊。",
    ctaPrimary: "预约咨询",
    ctaSecondary: "联系我们的团队",
  },
  eorPage: {
    ...
    faq: {
      ...
      a4:
        "跨境薪资在我们的模式下通过三个层面的管控来设计：司法辖区实体选择、劳务派遣架构，以及与条约对齐的税务定位。当客户的商业实质不足以支撑设立本地注册实体时，我们会动用新加坡持牌的 EOR 主体，结合在马来西亚、中国、印度、越南、泰国、印尼和阿联酋的双边劳务派遣架构——既消除常设机构风险，又保留对编制、KPI 和解雇权的运营控制。国际税务规划在首个薪资周期之前就已整合到位：在发起任何付款之前，我们就对外派成本转嫁、雇主侧社保缴款上限以及适用的双重征税条约定位之间的相互影响进行建模。",
  ...
  aboutPage: {
    ...
    founder: {
      ...
      p4:
        "十余年在亚洲的运营，让 Mars 建立起支撑每次跨境合作的本地法律、合规和人力资源运营网络——这些关系是通过在新加坡、马来西亚、香港、中国、印度和美国的实际落地积累下来的，不是为了某个委托临时拼凑的。",
    },
    numbers: {
      years: "成立年份",
      markets: "覆盖市场",
