// Bahasa Melayu — initial machine translation. Native review recommended.
...
const ms: Translation = {
  ...
  hero: {
    ...
    headlineAccent: "operator di belakang operator.",
    sub:
      "Employer of Record berlesen Singapura, pencarian eksekutif, dan infrastruktur HR di 8 pasaran APAC. Sejak 2009.",
    ctaPrimary: "Tempah Panggilan",
    ctaSecondary: "Terokai Perkhidmatan Kami",
    statYears: "Tahun beroperasi",
    statMarkets: "Pasaran APAC",
    statEmployers: "Syarikat dilayan",
    statConsultants: "Perunding pakar",
    statClients: "Pelanggan global",
    ...
    snapshotBadge: "3 lesen SG · 0 kelewatan statutori",
  },
  marquee: {
    label: "100+ syarikat · sejak 2009",
  },
  licenses: {
  ...
  twinPillars: {
    ...
    eor: {
      ...
      body:
        "Ambil, bayar, dan kekal patuh di Singapura serta 7 pasaran APAC lain — tanpa menubuhkan entiti tempatan. Kami mengendalikan kontrak pekerjaan, gaji, pemfailan statutori, dan offboarding sejak hari pertama.",
      bullet1: "Onboarding dalam 5 hari bekerja",
      bullet2: "CPF, EPF, BPJS, MPF, dan pemfailan cukai tempatan dikendalikan",
    ...
    recruitment: {
      ...
      body:
        "Penempatan tetap, staf kontrak, dan pencarian C-suite sulit di seluruh Singapura dan APAC. Kami mencari calon pasif yang tidak boleh dicapai platform lain, kemudian menyerahkan terus ke onboarding EOR apabila perlu.",
      bullet1: "2,560+ penempatan berjaya sejak 2009",
  ...
  whyMars: {
    ...
    p1:
      "Platform EOR global — Deel, Remote, Rippling — beroperasi pada model SaaS standard bervolum tinggi. Mereka berfungsi dengan baik sehingga tidak: pelaporan pampasan ekuiti merentas bidang kuasa, rundingan penamatan tidak standard di Indonesia, pendedahan PE yang memerlukan pendapat peguam sebelum kitaran gaji pertama.",
    p2:
  ...
  countries: {
    eyebrow: "Liputan",
    headline:
      "Ambil pekerja secara patuh di 8 pasaran APAC — di bawah satu kontrak Singapura.",
    body:
  ...
  comparison: {
    eyebrow: "EOR vs Entiti vs Kontraktor",
    headline: "Tiga cara untuk meletakkan seseorang di lapangan di Asia.",
    body:
      "Tubuhkan entiti sendiri, ambil sebagai kontraktor, atau gunakan Mars sebagai Employer of Record anda. Berikut perbandingan ketiga-tiganya pada nombor yang penting.",
    headers: {
      dimension: "Dimensi",
      entity: "Tubuh entiti tempatan",
      contractor: "Ambil sebagai kontraktor",
      mars: "Mars EOR",
    },
    rows: {
      time: {
        label: "Masa untuk ambil pekerja #1",
        entity: "3–9 bulan",
        contractor: "1–2 minggu",
        mars: "5 hari bekerja",
      },
      contract: {
        label: "Kontrak pekerjaan tempatan",
        entity: "Anda yang draf",
        contractor: "Bukan pekerjaan",
        mars: "Kontrak bahasa tempatan, IP & NDA",
      },
      payroll: {
      ...
      risk: {
        ...
        entity: "Rendah (entiti)",
        contractor: "Tinggi",
        mars: "Rendah (kami majikan)",
      },
      cost: {
        label: "Kos persediaan",
        entity: "USD 15–40k + berterusan",
        contractor: "Tiada",
        mars: "Yuran bulanan setiap pekerja",
      },
    },
    cta: "Dapatkan sebut harga negara demi negara",
  ...
  howItWorks: {
    ...
    step3: {
      ...
      desc:
        "Akaun statutori dibuka, peralatan dihantar, faedah didaftarkan. Kebanyakan pekerja onboard sepenuhnya dalam 5 hari bekerja.",
    },
    step4: {
  ...
  aiBlock: {
    ...
    title: "Inovasi AI",
    body:
      "Kami kini membantu pelanggan mengautomasikan aliran kerja HR dan operasi di belakang pengambilan mereka: ingestion cuti sakit melalui WhatsApp, prapemprosesan gaji berasaskan AI, dan perunding AI tertanam untuk pasukan yang membina keupayaan automasi dalaman.",
    cta: "Terokai Inovasi AI",
  },
  testimonial: {
    eyebrow: "Cerita pelanggan",
    headline: "Dipercayai oleh pasukan yang berkembang di seluruh APAC.",
    body:
      "Diasaskan di Singapura pada 2009, Mars Consulting telah berkembang dari butik pengambilan menjadi platform pekerjaan serantau — secara senyap menjalankan pengambilan, gaji dan pematuhan untuk startup AI, scale-up dan perusahaan berkaitan kerajaan di seluruh Asia Tenggara.",
    quote:
    ...
    location: "Singapura ↔ Jakarta · 12 pengambilan pada 2025",
    statClients: "Pelanggan global",
    statConsultants: "Perunding",
    statLicences: "Lesen SG",
  },
  contact: {
    eyebrow: "Bercakap dengan pakar berlesen Singapura",
    headline: "Lihat sama ada EOR pilihan tepat — dalam 20 minit.",
    ...
    submit: "Tempah panggilan 20 minit saya",
    privacy:
      "Kami balas dalam 4 jam bekerja, waktu Singapura. Dengan menghantar anda bersetuju dengan dasar privasi kami.",
  },
  footer: {
    tagline:
      "Employer of Record berlesen Singapura dan perkhidmatan HR di seluruh Asia Tenggara. Sejak 2009.",
    sections: {
  ...
  eorPage: {
    ...
    metaDesc:
      "Perkhidmatan EOR berlesen Singapura di 8 pasaran. Pekerjaan, gaji, dan pemfailan statutori patuh sejak hari pertama. Tiada entiti tempatan diperlukan. MOM EA 09C2925.",
    pill: "Employer of Record & Gaji Global",
    headlineLead: "Ambil pekerja secara patuh di",
    headlineAccent: "8 pasaran APAC",
    ...
    trustLine: "Lesen MOM EA No. 09C2925 · 17 tahun · 8 pasaran APAC · Onboarding 5 hari",
    stats: {
      onboarding: "Onboarding",
      onboardingValue: "5 hari",
      coverage: "Liputan APAC",
      coverageValue: "8 pasaran",
    ...
    faq: {
      eyebrow: "Soalan Lazim",
      headline: "Soalan yang kami terima daripada pembeli serius",
      sub:
      ...
      q6: "Bagaimana pendekatan Mars terhadap perancangan cukai antarabangsa berkenaan kedudukan perjanjian dan recharge secondment?",
      a6:
  ...
  recruitmentPage: {
    ...
    metaDesc:
      "Penempatan tetap, staf kontrak dan pencarian eksekutif C-suite sulit di seluruh Singapura dan APAC. 2,560+ penempatan berjaya. 17 tahun. Berlesen MOM.",
    pill: "Pengambilan & Pencarian Eksekutif",
    headlineLead: "Pengambilan & Pencarian Eksekutif di",
    headlineAccent: "Singapura dan APAC",
    sub:
      "Penempatan tetap, staf kontrak, dan pencarian C-suite sulit — disampaikan oleh pengamal yang telah menempatkan lebih 2,560 calon merentasi teknologi, perkhidmatan kewangan, kesihatan, dan pembuatan sejak 2009.",
    ctaPrimary: "Bincang Mandat Pencarian",
    ctaSecondary: "Lihat Proses Kami",
    trustLine: "Lesen MOM EA No. 09C2925 · 17 tahun · 8 pasaran APAC",
    tracks: {
      eyebrow: "Trek perkhidmatan",
      headline: "Tiga trek pencarian. Satu pasukan.",
      permanent: {
        title: "Penempatan Tetap",
        body:
          "Pengambilan tetap pertengahan ke senior merentasi semua industri. Kami mencari calon aktif dan pasif, menjalankan temu duga berstruktur, dan menyajikan senarai pendek tervet — bukan dump CV.",
        suitable: "Tahap Pengurus ke Pengarah · Semua industri · Singapura dan peranan serantau",
      },
      contract: {
        title: "Staf Kontrak & Sementara",
        body:
          "Pengambilan jangka pendek, berasaskan projek, dan interim dengan pematuhan statutori penuh. Sangat berkesan untuk ramp projek BPO, cuti ibu bapa, dan headcount masuk pasaran sebelum keputusan ambilan tetap.",
        suitable: "Engagement 3–24 bulan · Pasukan projek · Masuk pasaran",
      },
      executive: {
        title: "Pencarian Eksekutif & C-Suite",
        body:
          "Pencarian retained dan sulit untuk mandat C-suite, VP, dan tahap Lembaga. Kami komited menyampaikan senarai pendek calon pasif tervet sepenuhnya dan sedia-bidang kuasa dalam sprint awal 21 hari, ditadbir oleh SLA berasaskan milestone.",
        suitable: "CEO, CFO, CTO, COO, VP ke atas · Mandat rentas sempadan · Pencarian stealth",
      },
    },
    industries: {
      eyebrow: "Industri",
      headline: "Merentasi setiap industri. Pakar dalam empat.",
      tech: "Teknologi & SaaS",
      finance: "Perkhidmatan Kewangan & Fintech",
      health: "Kesihatan & Sains Hayat",
      manufacturing: "Pembuatan & Industri",
      realestate: "Hartanah & Pembinaan",
      retail: "Runcit & E-dagang",
      services: "Perkhidmatan Profesional",
      government: "Kerajaan & Sektor Awam",
    },
    process: {
      eyebrow: "Bagaimana ia berfungsi",
      headline: "Bagaimana pencarian berfungsi dengan Mars",
      ...
      step4Title: "Penilaian Berstruktur",
      step4Body:
        "Setiap calon yang dipersembahkan telah lulus temu duga kompetensi berstruktur, penjajaran semakan rujukan, dan rangka kerja pengesahan latar belakang khusus bidang kuasa.",
      step5Title: "Persembahan Senarai Pendek",
      step5Body:
        "Anda menerima senarai pendek 3–5 calon berkelayakan sepenuhnya dalam jadual sprint dipersetujui, dengan ringkasan penilaian bertulis.",
      step6Title: "Tawaran & Tutup",
      step6Body:
        "Kami uruskan rundingan tawaran, senario counter-offer, dan peralihan tempoh notis. Untuk pengambilan serantau, kami berkoordinasi terus dengan pasukan onboarding EOR.",
    },
    integration: {
      eyebrow: "Pengambilan + EOR",
      headline: "Dari surat tawaran ke hari pertama — tanpa jurang",
      p1:
        "Titik geseran tradisional dalam ekspansi antarabangsa ialah hand-off antara pemerolehan bakat dan pematuhan HR tempatan. Kebanyakan firma menganggap ini sebagai workstream berasingan. Mars tidak.",
      p2:
        "Saat seorang calon menerima tawaran, enjin pematuhan EOR kami memulakan urutan onboarding tempatan serentak dengan tempoh notis calon. Kontrak pekerjaan didraf. Kebenaran kerja dimulakan. Profil gaji ditetapkan. Akaun statutori dibuka.",
      p3:
        "Pada masa calon masuk pada hari pertama, mereka patuh sepenuhnya dan operasi. Bukan tertunda.",
    ...
    faq: {
      eyebrow: "Soalan Lazim",
      headline: "Soalan yang kami terima pada mandat eksekutif",
      q1: "Apakah model SLA untuk mandat pencarian C-suite dan VP rentas sempadan?",
      a1:
        "Melaksanakan mandat C-suite dan VP rentas sempadan memerlukan ketepatan mutlak dan jadual pelaksanaan terjamin. Model pencarian retained kami ditadbir oleh Service Level Agreement berasaskan milestone yang ketat. Kami tidak bergantung pada agregasi job board pasif. Sebaliknya, kami komited menyampaikan senarai pendek calon pasif tervet sepenuhnya dan sedia-bidang kuasa dalam sprint awal 21 hari. SLA mendefinisikan metrik ketat untuk persembahan calon, penjadualan temu duga, dan rundingan tawaran akhir. Dengan mengikat irama operasi kami pada deliverable kontraktual keras, kami menyediakan ibu pejabat MNC kebolehramalan diperlukan untuk menyelaraskan peralihan eksekutif kritikal dengan jadual masuk pasaran strategik dan ekspansi rentas sempadan lebih luas.",
      q2: "Bagaimana pengesahan latar belakang dikendalikan merentasi bidang kuasa bercampur dengan undang-undang privasi terpecah?",
      a2:
        "Semakan latar belakang rentas bidang kuasa menghadapi undang-undang privasi dan akses data sangat terpecah. Walaupun probiti kewangan mudah disahkan di Singapura, bidang kuasa seperti EU atau China daratan mengenakan had ketat pada akses litigasi sivil atau sejarah pekerjaan. Mars menavigasi jurang ini dengan memetakan protokol pengesahan kepada realiti undang-undang tempatan, memastikan pematuhan ICA/MOM ketat di Singapura dan rangka kerja serupa di luar negara. Di mana pengesahan pangkalan data langsung disekat secara sah, kami menggunakan rangka kerja deep-referencing — menganalisis jejak profesional tidak langsung dan melaksanakan temu duga multi-tier berstruktur dengan atasan terdahulu untuk membina profil risiko fideliti tinggi walaupun rekod statutori kekal legap.",
    },
    ctaBanner: {
  ...
  aiPage: {
    ...
    compliance: {
      eyebrow: "Residensi data & tadbir urus",
      headline: "Sejajar PDPA. Loop tertutup. Sifar kebocoran latihan.",
      p1:
        "Menggunakan LLM dalam sumber manusia memerlukan tadbir urus data ketat. Seni bina AI kami beroperasi secara ketat pada instance model loop tertutup peringkat enterprise. Data HR pelanggan tidak pernah digunakan untuk latihan model asas.",
      p2:
        "Kami menguatkuasakan protokol residensi data ketat, memastikan semua pemprosesan dan penyimpanan maklumat peribadi berlaku pada pelayan berdaulat tempatan sejajar dengan arahan pematuhan pelanggan. Bidang sensitif menjalani anonimisasi dan tokenisasi terprogram sebelum pemprosesan LLM.",
      badgeTitle: "PDPA · Residensi data Singapura",
      badgeBody:
        "Kawalan kerahsiaan kekal tidak terputus sambil merealisasikan kelajuan operasi AI generatif.",
    },
    faq: {
      eyebrow: "Soalan Lazim",
  ...
  aboutPage: {
    ...
    metaDesc:
      "Mars Consulting diasaskan di Singapura pada April 2009. 17 tahun pengalaman HR, EOR, dan pencarian eksekutif merentasi 8 pasaran APAC. Lesen MOM EA No. 09C2925.",
    ...
    sub:
      "Mars Consulting diasaskan di Singapura pada April 2009 dengan satu keyakinan: bahawa perniagaan hebat dibina oleh orang yang tepat, ditempatkan dalam peranan yang tepat, disokong oleh sistem yang tepat. Hari ini kami adalah rakan HR perkhidmatan penuh merentasi 8 pasaran — menyediakan Employer of Record, gaji global, pencarian eksekutif, outsourcing HR, dan automasi proses berasaskan AI kepada syarikat di setiap peringkat pertumbuhan.",
    timeline: {
    ...
    founder: {
      eyebrow: "Pengasas",
      headline: "Diketuai pengamal. Bukan diketuai perunding.",
      p1Lead: "Mars Consulting diasaskan oleh",
      p1Name: "Yuggie Wang",
      p1Tail:
        ", profesional HR dan sistem enterprise berpangkalan di Singapura dengan kepakaran mendalam dalam platform SAP HR dan strategi pengurusan tenaga kerja.",
      p2:
    ...
    licences: {
      ...
      headline: "Berlesen, dikawal selia, dan akauntabel",
      body:
        "Mars Consulting beroperasi di bawah pematuhan pengawalseliaan penuh di Singapura. Lesen dan pendaftaran kami boleh disahkan secara umum di daftar MOM dan ACRA.",
      momAuthority: "Kementerian Sumber Manusia (MOM)",
      momLabel: "Lesen EA Komprehensif",
      momCode: "Lesen No. 09C2925",
      momNote:
    ...
    principles: {
      ...
      honestTitle: "Penetapan skop jujur",
      honestBody:
    ...
    ctaBanner: {
      headline: "17 tahun menjadi operator di belakang operator",
      body:
