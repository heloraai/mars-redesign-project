...
const vi: Translation = {
  ...
  hero: {
    ...
    statLicence: "Giấy phép MOM EA",
    statAcra: "Đại lý Nộp hồ sơ ACRA",
    statAcraValue: "RFA",
    ...
    snapshotPayroll: "Kỳ chạy bảng lương",
    snapshotPayrollValue: "SGD 412,890 · đã thanh toán",
    snapshotBadge: "Được cấp phép MOM · 0 vi phạm theo luật từ 2009",
    snapshotEmployeesLabel: "nhân viên",
    snapshotTaxSG: "CPF · IR8A đã nộp",
    snapshotTaxMY: "EPF · SOCSO đã nộp",
    snapshotTaxHK: "MPF đã nộp",
    snapshotTaxCN: "Bảo hiểm Xã hội đã nộp",
    snapshotTaxVN: "BHXH đã nộp",
    snapshotTaxTH: "An sinh Xã hội đã nộp",
    snapshotTaxID: "BPJS đã nộp",
  },
  marquee: {
    label:
      "Được cấp phép MOM Singapore · Thành lập từ 2009 · 10 thị trường · EOR & Bảng lương · Tuyển dụng · Tự động hóa AI · 100+ chuyên gia tư vấn · Giấy phép MOM EA 09C2925",
  },
  licenses: {
    eyebrow: "Được cấp phép & quản lý tại Singapore",
    mom: {
      authority: "Bộ Nhân lực",
      label: "Giấy phép Đại lý Việc làm Toàn diện",
  ...
  countries: {
    ...
    statMisses: "Vi phạm theo luật (từ 2009)",
    statLicences: "Được cấp phép MOM",
    legendOffice: "Văn phòng",
    legendService: "Thị trường dịch vụ",
    name: {
      SG: "Singapore",
      MY: "Malaysia",
      HK: "Hồng Kông",
  ...
  comparison: {
    ...
    body:
      "Thành lập pháp nhân riêng, thuê làm nhà thầu, hoặc dùng Mars làm Employer of Record. Đây là cách ba phương án so sánh trên các con số quan trọng.",
    headers: {
      dimension: "Tiêu chí",
    ...
    rows: {
      ...
      payroll: {
        label: "Bảng lương & nộp hồ sơ theo luật",
        entity: "Bạn tự chạy + nộp",
        contractor: "Người lao động tự nộp",
        mars: "CPF/EPF/BPJS/MPF và tương đương — chúng tôi nộp",
      },
      risk: {
  ...
  howItWorks: {
    ...
    step1: {
      ...
      desc:
        "Chia sẻ quốc gia, vai trò, dải mức lương và ngày bắt đầu. Chúng tôi sẽ báo giá trong 4 giờ làm việc, kèm phân tích chi phí theo luật đầy đủ.",
    },
    step2: {
      title: "Chúng tôi soạn hợp đồng địa phương",
      desc:
        "Thỏa thuận lao động tuân thủ, chuyển giao IP và NDA bằng tiếng địa phương. Xác nhận cổ phần (RSU / ISO / phantom) được xử lý nếu bạn có.",
    },
    step3: {
      title: "Nhân viên ký & onboard",
      desc:
        "Mở tài khoản theo luật, vận chuyển thiết bị, đăng ký phúc lợi. Hầu hết nhân viên được onboard hoàn toàn trong 5 ngày làm việc.",
    },
    step4: {
      title: "Chúng tôi chạy bảng lương & tuân thủ",
      desc:
        "Một hóa đơn hàng tháng từ Mars. CPF, EPF, BPJS, MPF và các khoản nộp hồ sơ theo luật tương đương tại mỗi thị trường — chúng tôi gửi báo cáo cho bạn; bạn không phải làm gì.",
    },
  },
  clients: {
  ...
  aiBlock: {
    ...
    body:
      "Chúng tôi triển khai các quy trình điều khiển bằng AI cùng với các chuyên gia HR cấp cao để tự động hóa các quy trình ma sát cao xung quanh các đội ngũ phân tán: tiền xử lý bảng lương, onboarding và offboarding nhân viên, và quản lý giấy chứng nhận y tế qua WhatsApp — để đội ngũ của bạn quản lý con người, không phải giấy tờ.",
    cta: "Khám phá Tự động hóa AI",
  },
  testimonial: {
    ...
    location: "Singapore ↔ APAC · Triển khai EOR đa thị trường · 2025",
    statConsultants: "Chuyên gia tư vấn",
    statLicences: "Được cấp phép MOM",
  },
  contact: {
    eyebrow: "Trao đổi với chuyên gia có giấy phép Singapore",
    headline: "Trao đổi với chuyên gia có giấy phép Singapore — trong 30 phút.",
    bullet1: "Phân tích chi phí từng quốc gia",
    bullet2: "Mẫu hợp đồng & checklist onboarding",
    bullet3: "Trả lời thẳng thắn liệu bạn có nên thành lập pháp nhân thay thế",
    response: "Phản hồi trung bình: dưới 4 giờ làm việc",
    label: {
      service: "Chúng tôi có thể giúp gì?",
      email: "Email công việc",
      company: "Công ty",
      country: "Quốc gia hoặc khu vực quan tâm",
      hires: "Quy mô đội ngũ bạn muốn tuyển",
    },
    placeholder: {
      service: "Chọn một dịch vụ",
      email: "ban@congty.com",
      company: "Tên công ty",
      country: "vd. Trung Quốc, Malaysia, UAE",
      hires: "vd. 5",
    },
    serviceOptions: {
      eor: "EOR & Bảng lương",
    ...
    submit: "Đặt lịch cuộc gọi 30 phút",
    privacy:
      "Chúng tôi phản hồi trong 4 giờ làm việc, giờ Singapore.",
    consent: "Bằng việc gửi, bạn đồng ý với Chính sách Bảo mật của chúng tôi.",
    consentLink: "Chính sách Bảo mật",
    consentUrl: "/privacy",
    infoEyebrow: "Các cách khác để liên hệ với chúng tôi",
    emailLabel: "Yêu cầu chung",
    ...
    hoursValue: "Thứ Hai – Thứ Sáu, 9:00 – 18:00 SGT",
    linkedinLabel: "LinkedIn",
    linkedinValue: "Xem đội ngũ của chúng tôi trên LinkedIn",
    linkedinUrl: "https://www.linkedin.com/company/marsconsulting%E9%BA%A6%E5%A3%AB%E5%92%A8%E8%AF%A2/",
    teamHintLabel: "Muốn gặp đội ngũ trước?",
    teamHintValue: "Các chuyên gia tư vấn và nhà tuyển dụng của chúng tôi được liệt kê công khai trên LinkedIn.",
  },
  footer: {
    tagline:
      "Mars Consulting Pte Ltd — Employer of Record, tuyển dụng và vận hành HR có giấy phép Singapore trên 10 thị trường. Giấy phép MOM EA Số 09C2925. Thành lập 2009.",
    sections: {
      solutions: "Giải pháp",
      company: "Công ty",
      compliance: "Tuân thủ",
  ...
  eorPage: {
    ...
    metaDesc:
      "Dịch vụ EOR có giấy phép Singapore trên 10 thị trường. Lao động, bảng lương và nộp hồ sơ theo luật tuân thủ ngay từ ngày đầu. Không cần pháp nhân địa phương. MOM EA 09C2925.",
    pill: "Employer of Record & Bảng lương Toàn cầu",
    headlineLead: "Tuyển dụng tuân thủ trên",
    headlineAccent: "10 thị trường",
    headlineTail: "— không cần thành lập pháp nhân địa phương",
    sub:
      "Dịch vụ Employer of Record có giấy phép Singapore. Chúng tôi trở thành nhà tuyển dụng hợp pháp; bạn chỉ đạo công việc. Hợp đồng lao động, bảng lương, nộp hồ sơ theo luật và offboarding được xử lý ngay từ ngày đầu tiên.",
    ctaPrimary: "Nhận Báo giá EOR",
    ctaSecondary: "Xem Cách hoạt động",
    trustLine:
      "Giấy phép MOM EA Số 09C2925 · Thành lập từ 2009 · 10 thị trường · Onboarding 5 ngày",
    stats: {
      onboarding: "Onboarding",
      onboardingValue: "5 ngày",
      coverage: "Thị trường phục vụ",
      coverageValue: "10",
      clients: "Chuyên gia tư vấn",
      clientsValue: "100+",
      misses: "Vi phạm theo luật (từ 2009)",
      missesValue: "0",
    },
    included: {
      title: "Những gì chúng tôi xử lý thay bạn",
      item1: "Hợp đồng lao động bằng tiếng địa phương, đặc thù khu vực pháp lý",
      item2: "Quản lý quy trình onboarding và thôi việc",
      item3: "Xử lý bảng lương và quản lý thuế",
      item4: "Các khoản đóng góp theo luật: CPF, EPF, BPJS, MPF, FICA, BHXH và tương đương",
      item5: "Offboarding, tính lương cuối cùng và thanh toán theo luật",
      item6: "Phối hợp tai nạn nghề nghiệp và sự cố nơi làm việc",
    },
    faq: {
      eyebrow: "Câu hỏi thường gặp",
      headline: "Những câu hỏi chúng tôi nhận từ người mua nghiêm túc",
      sub:
    ...
    ctaBanner: {
      ...
      body:
        "Phân tích chi phí từng quốc gia. Mẫu hợp đồng & checklist onboarding. Trả lời thẳng thắn liệu bạn có nên thành lập pháp nhân thay thế.",
  ...
  recruitmentPage: {
    ...
    metaDesc:
      "Tuyển dụng cố định, nhân viên hợp đồng và tìm kiếm điều hành C-suite bí mật trên khắp Singapore và khu vực. Có giấy phép MOM EA từ 2009. Công nghệ, dịch vụ tài chính, y tế, sản xuất.",
    ...
    tracks: {
      eyebrow: "Các hướng dịch vụ",
      headline: "Ba hướng tìm kiếm. Một đội ngũ.",
      permanent: {
    ...
    industries: {
      eyebrow: "Các ngành",
      headline: "Trên mọi ngành. Chuyên gia trong bốn.",
      tech: "Công nghệ & SaaS",
    ...
    stats: {
      serviceTracks: "Các hướng dịch vụ",
  ...
  aiPage: {
    metaTitle: "Tự động hóa HR bằng AI Singapore — Mars Consulting",
    metaDesc:
      "Tự động hóa quy trình HR bằng AI cho các đội ngũ phân tán trên khắp châu Á, Trung Đông và Hoa Kỳ. Tự động hóa MC qua WhatsApp, tiền xử lý bảng lương AI, tự động hóa onboarding/offboarding, các chuyên gia tư vấn AI nhúng. Từ 2025.",
    pill: "Tự động hóa AI · Từ 2025",
    headlineLead: "Tự động hóa các quy trình HR",
    headlineAccent: "đang làm chậm đội ngũ của bạn.",
    sub:
      "Chúng tôi triển khai các quy trình điều khiển bằng AI cùng với các chuyên gia HR cấp cao để tự động hóa các quy trình ma sát cao xung quanh các đội ngũ phân tán: tiền xử lý bảng lương, onboarding và offboarding nhân viên, và quản lý giấy chứng nhận y tế qua WhatsApp — để đội ngũ của bạn quản lý con người, không phải giấy tờ.",
    ctaPrimary: "Trao đổi với Đội AI",
    ctaSecondary: "Xem Năng lực",
    trustBadge1: "Tuân thủ PDPA",
    trustBadge2: "Cư trú dữ liệu Singapore",
    trustBadge3: "Các phiên bản mô hình closed-loop",
    capabilities: {
      eyebrow: "Những gì chúng tôi xây dựng",
      headline: "Bốn năng lực. Một lớp vận hành.",
      whatsapp: {
        title: "Bot Tự động hóa HR WhatsApp",
        body:
          "Một bot tự động hóa dựa trên WhatsApp an toàn hoạt động như một nhân viên kỹ thuật số được điều khiển bằng AI. Nhân viên gửi hình ảnh giấy chứng nhận y tế hoặc biên lai chi phí trực tiếp qua WhatsApp; trích xuất có cấu trúc điều khiển bằng OCR + LLM xác định ngày tháng, tên phòng khám, mã chẩn đoán và thời gian nghỉ.",
      ...
      onboarding: {
        ...
        body:
          "Các quy trình vòng đời nhân viên tự động — từ chấp nhận đề nghị qua thiết lập tài khoản theo luật đến offboarding và xử lý lương cuối cùng. Tích hợp với HRIS và các hệ thống báo cáo theo luật để loại bỏ các bước thủ công khỏi mọi giai đoạn của hành trình nhân viên.",
        bullet1: "Tạo tài khoản theo luật tự động khi tuyển dụng",
        bullet2: "Offboarding được kích hoạt bởi thôi việc hoặc kết thúc hợp đồng",
        bullet3: "Lương cuối cùng và thanh toán được xử lý trong các hạn theo luật",
      },
    },
    compliance: {
      ...
      p2:
        "Chúng tôi thực thi các giao thức cư trú dữ liệu nghiêm ngặt, đảm bảo rằng mọi xử lý và lưu trữ thông tin nhận dạng cá nhân diễn ra trên các máy chủ chủ quyền, địa phương phù hợp với các chỉ thị tuân thủ của khách hàng. Các trường nhạy cảm trải qua ẩn danh hóa và token hóa lập trình trước khi xử lý LLM.",
      badgeTitle: "PDPA · Cư trú dữ liệu Singapore",
      badgeBody:
        "Các kiểm soát bảo mật vẫn không bị phá vỡ trong khi đạt được tốc độ vận hành của AI tạo sinh.",
    },
    faq: {
      eyebrow: "Câu hỏi thường gặp",
    ...
    roadmap: {
      eyebrow: "Điều gì tiếp theo",
      headline: "Xây dựng lớp tiếp theo của hạ tầng lực lượng lao động.",
      body:
        "Mars đang phát triển hạ tầng Hộ chiếu Việc làm Kỹ thuật số — các hồ sơ có thể xác minh, có thể mang theo về lịch sử việc làm và kỹ năng đi cùng nhân viên. Chúng tôi cũng đang xây dựng các khung micro-credential kết nối các kết quả đào tạo lực lượng lao động trực tiếp với các hồ sơ tuân thủ của nhà tuyển dụng. Nếu bạn đang lập kế hoạch hạ tầng công nghệ HR cho ba đến năm năm tới, hãy trao đổi với chúng tôi sớm.",
      cta: "Trao đổi với Đội AI",
    },
  },
  aboutPage: {
    ...
    headlineTail: "Được xây dựng tại Singapore từ 2009.",
    sub:
    ...
    timeline: {
      ...
      y2020:
        "Giới thiệu HR Outsourcing — nhúng các chuyên gia tư vấn HR có kinh nghiệm trực tiếp trong các tổ chức khách hàng cho công việc chiến lược và vận hành. Mở rộng hệ sinh thái dịch vụ để bao gồm các quan hệ đối tác học tập và đào tạo doanh nghiệp, cung cấp cho khách hàng quyền truy cập vào hạ tầng phát triển kỹ năng cùng với quản lý lực lượng lao động.",
      y2025:
    ...
    founder: {
      ...
      headline: "Dẫn dắt bởi người thực hành. Không phải bởi tư vấn.",
      p1Lead: "Mars Consulting được thành lập bởi",
      p1Name: "Yuggie Wang",
      p1Tail:
        ", một chuyên gia HR và hệ thống doanh nghiệp tại Singapore với chuyên môn sâu về các nền tảng SAP HR và chiến lược quản lý lực lượng lao động.",
      p2:
    ...
    numbers: {
      years: "Thành lập",
      markets: "Thị trường phục vụ",
      consultants: "Chuyên gia tư vấn",
      licences: "Giấy phép MOM EA",
    },
    team: {
    ...
    licences: {
      ...
      body:
        "Mars Consulting hoạt động dưới tuân thủ quy định đầy đủ tại Singapore. Các giấy phép và đăng ký của chúng tôi có thể xác minh công khai trên các đăng ký MOM và ACRA.",
      momAuthority: "Bộ Nhân lực (MOM)",
      momLabel: "Giấy phép EA Toàn diện",
      momCode: "Giấy phép Số 09C2925",
      momNote:
        "Giấy phép Đại lý Việc làm — ủy quyền đặt các ứng viên trong nước và nước ngoài tại Singapore.",
      acraAuthority: "ACRA Singapore",
      acraLabel: "Nhà cung cấp Dịch vụ Doanh nghiệp",
      acraCode: "Đại lý Nộp hồ sơ Đăng ký (RFA)",
      acraNote: "Đăng ký Cơ quan Quy định Kế toán và Doanh nghiệp.",
      entityLabel: "Pháp nhân đăng ký",
      ...
      entityNote: "Chi tiết công ty có thể xác minh công khai trên ACRA BizFile+.",
      verifiable:
        "Chi tiết giấy phép có thể xác minh công khai trên Danh bạ Đại lý Việc làm MOM và đăng ký ACRA BizFile+.",
    },
    offices: {
      eyebrow: "Các văn phòng của chúng tôi",
      headline: "Nơi chúng tôi hoạt động.",
      body: "Mars Consulting duy trì 6 văn phòng và cung cấp các dịch vụ EOR, bảng lương và HR trên 10 thị trường.",
      sg: {
        country: "Singapore",
        badge: "Trụ sở chính",
    ...
    ctaBanner: {
      headline: "Thành lập từ 2009. Được xây dựng để là nhà điều hành đứng sau nhà điều hành.",
      body:
        "Trao đổi với một chuyên gia có giấy phép Singapore về EOR, tìm kiếm điều hành hoặc tự động hóa HR bằng AI trên 10 thị trường.",
      cta: "Đặt lịch Tư vấn",
    },
  },
  hrOutsourcingPage: {
    metaTitle: "HR Outsourcing Singapore — Các Chuyên gia Tư vấn HR Nhúng | Mars Consulting",
    metaDesc:
      "Các chuyên gia tư vấn HR nhúng cho các công ty cần năng lực HR cấp cao mà không cần thuê một giám đốc HR toàn thời gian. Trên khắp Singapore và khu vực. Được cấp phép MOM EA.",
    pill: "HR Outsourcing & HR Nhúng",
    headlineLead: "Năng lực HR cấp cao",
    ...
    useCases: {
      ...
      case3: "Giám đốc HR nghỉ phép kéo dài — bao phủ tạm thời với tính liên tục",
      case4: "Các dự án đặc biệt — tái cấu trúc, các chương trình tinh giản, đại tu chính sách",
    },
    included: {
      eyebrow: "Những gì được bao gồm",
      item1: "Chuyên gia HR cấp cao được nhúng bán thời gian hoặc toàn thời gian",
      item2: "Thiết kế và tài liệu hóa khung chính sách",
  ...
  faqPage: {
    metaTitle: "Câu hỏi Thường gặp — Mars Consulting",
    metaDesc:
      "Các câu hỏi thường gặp về các dịch vụ Employer of Record, tìm kiếm điều hành, bảng lương và tự động hóa AI của Mars Consulting trên 10 thị trường.",
    pill: "Câu hỏi thường gặp",
    headlineLead: "Những câu hỏi chúng tôi nhận từ",
    headlineAccent: "người mua nghiêm túc.",
    sub:
      "Câu trả lời cho những câu hỏi khách hàng của chúng tôi đặt ra ở cuộc gọi thứ hai hoặc thứ ba. Chúng tôi đặt chúng ở đây để bạn có thể hỏi ngay từ cuộc gọi đầu tiên.",
    about: {
